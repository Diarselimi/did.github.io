...
Your are going to learn how to implement a endpoint Implementation.

You are going to learn about a new application structure.
...
All the endpoints we are going to name are going to follow [REST API](https://restfulapi.net/) guidelines.
...
```php
//create a class which identifies key words in a text
