...
This is the last diagram in this article, but keep in mind that C4 has 4 levels,
but that will come in the next articles since each component has to be represented in a diagram.
