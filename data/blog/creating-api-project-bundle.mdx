...
Things that you are going to learn are, Modeling, Design, Api documentation and CI/CD.
...
I want to have an API which analyses a list of articles which we are going to get from [api.dev.to/articles](),
...
You need to already have experience with Mysql, PHP and OOP.
