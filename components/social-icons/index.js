...
const SocialIcon = ({ kind, href, size = 8 }) => {
  ...
  return (
    <a
      className="ease mb-1 mr-1 inline-flex items-center rounded-full border-2 border-blue-600 p-3 text-white transition duration-200 hover:border-blue-700 hover:bg-blue-700"
      target="_blank"
